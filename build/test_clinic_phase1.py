...
Usage:
  python3 build/test_clinic_phase1.py                       # every entry, level 1, laptop
  python3 build/test_clinic_phase1.py --level 2 --viewport ipad
  python3 build/test_clinic_phase1.py --all-sizes --only visit:hurt
  python3 build/test_clinic_phase1.py --say wrong            # the stub recogniser mishears first
